    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Important logic is covered by unit and integration tests. UI flows are designed for browser automation and manual smoke testing.",
        ],
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "重要逻辑需要单元测试和集成测试。UI 流程要能被浏览器自动化和手动冒烟验证。",
        ],
        code: "bun run lint\nbun run typecheck\nbun test\nbun run build\nbun run build:binary\nbun run smoke:binary\nbun run smoke:pi-rpc",
      },
      {
